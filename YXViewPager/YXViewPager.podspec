...
Pod::Spec.new do |s|
  s.name             = 'YXViewPager'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YXViewPager.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'yixiangboy' => 'yixiang.yx@alibaba-inc.com' }
  s.source           = { :git => 'https://github.com/yixiangboy/YXViewPager.git', :tag => s.version.to_s }
