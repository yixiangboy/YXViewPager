//
//  YXViewPagerSub0ViewController.m
//  YXViewPager
//
...
@interface YXViewPagerSub0ViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>

@property (nonatomic, strong) UICollectionView *collectionView;

@end

@implementation YXViewPagerSub0ViewController
